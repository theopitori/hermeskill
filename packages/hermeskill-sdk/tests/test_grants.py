...
from hermeskill.apoptosis import build_death_certificate
from hermeskill.checks import Terminal, Warning, apply_grants
from hermeskill.policies import resolve_policy
from hermeskill.types import SymptomType, TriggerType
...
def _apply_results(state: WatcherState, verdicts: list[Terminal | Warning]) -> None:
    ...
    framework adapter's hook bridge (e.g. hermeskill_hermes.bridge.on_pre_tool_call).
    Lives here rather than in hermeskill.checks to keep the SDK framework-agnostic.
    """
