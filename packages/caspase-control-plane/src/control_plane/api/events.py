"""Events router: batched ingest from the SDK, paginated read for `caspase logs`.
...
- **Tailing** (`after_id` cursor): ascending order. Used by
  `caspase logs --follow` to poll for events newer than the last one seen.
"""

from typing import Annotated
from uuid import UUID

from caspase.types import EventBatchIn, EventOut, EventPage, EventType
