...
Loop / cost / scope detection deliberately stay in-process (`caspase.checks`) —
...
logger = logging.getLogger("caspase.supervisor")
...
class ProcessSupervisor:
    ...
    def _record(self, step: str, detail: dict[str, Any]) -> None:
        ...
        logger.debug("caspase supervisor: %s %s", step, detail)
