...
The worker tests use a real CaspaseClient over httpx.MockTransport so we
...
def _client_capturing(calls: list[dict[str, Any]]) -> CaspaseClient:
    """A CaspaseClient that records every request to `calls`."""
